    ...
    GovernorTimelockControl
{
    constructor(
        ...
        Governor(_contractName)
        GovernorSettings(
            _votingDelay /* in blocks */,
            _votingPeriod /* in weeks : eanch block is 13.2 sec */,
            _proposalThreshold /* number of votes required for a voter to be a proposer*/
        )
