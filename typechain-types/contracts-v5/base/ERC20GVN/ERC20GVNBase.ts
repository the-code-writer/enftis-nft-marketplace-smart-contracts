...
export interface ERC20GVNBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC20GVNBase extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20GVNBase;
  waitForDeployment(): Promise<this>;

  interface: ERC20GVNBaseInterface;
