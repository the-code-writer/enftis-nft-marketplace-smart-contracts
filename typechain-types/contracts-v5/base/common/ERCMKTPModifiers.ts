...
export interface ERCMKTPModifiersInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "callFallback"
...
export interface ERCMKTPModifiers extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPModifiers;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPModifiersInterface;
