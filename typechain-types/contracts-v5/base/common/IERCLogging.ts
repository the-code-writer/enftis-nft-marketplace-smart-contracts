...
export interface IERCLoggingInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IERCLogging extends BaseContract {
  connect(runner?: ContractRunner | null): IERCLogging;
  waitForDeployment(): Promise<this>;

  interface: IERCLoggingInterface;
