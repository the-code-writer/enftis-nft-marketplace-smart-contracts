...
export interface ERC20DAOBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface ERC20DAOBase extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20DAOBase;
  waitForDeployment(): Promise<this>;

  interface: ERC20DAOBaseInterface;
