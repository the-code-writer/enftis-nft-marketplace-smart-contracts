...
export interface ERCMKTPFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_listedItems"
...
export interface ERCMKTPFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactory;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryInterface;
