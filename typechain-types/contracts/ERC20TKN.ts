...
export interface ERC20TKNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC20TKN extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20TKN;
  waitForDeployment(): Promise<this>;

  interface: ERC20TKNInterface;
