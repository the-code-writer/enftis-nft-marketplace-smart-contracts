...
export interface ERC20GVNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC20GVN extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20GVN;
  waitForDeployment(): Promise<this>;

  interface: ERC20GVNInterface;
