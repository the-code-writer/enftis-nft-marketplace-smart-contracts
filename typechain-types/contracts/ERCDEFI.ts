...
export interface ERCDEFIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BONUS_MULTIPLIER"
      | "add"
...
export interface ERCDEFI extends BaseContract {
  connect(runner?: ContractRunner | null): ERCDEFI;
  waitForDeployment(): Promise<this>;

  interface: ERCDEFIInterface;
