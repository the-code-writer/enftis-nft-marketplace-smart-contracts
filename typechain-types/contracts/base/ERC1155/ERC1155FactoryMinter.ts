...
export interface ERC1155FactoryMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_tokenCurrentSupply"
...
export interface ERC1155FactoryMinter extends BaseContract {
  connect(runner?: ContractRunner | null): ERC1155FactoryMinter;
  waitForDeployment(): Promise<this>;

  interface: ERC1155FactoryMinterInterface;
