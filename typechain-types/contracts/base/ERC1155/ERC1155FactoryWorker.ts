...
export interface ERC1155FactoryWorkerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_tokenCurrentSupply"
...
export interface ERC1155FactoryWorker extends BaseContract {
  connect(runner?: ContractRunner | null): ERC1155FactoryWorker;
  waitForDeployment(): Promise<this>;

  interface: ERC1155FactoryWorkerInterface;
