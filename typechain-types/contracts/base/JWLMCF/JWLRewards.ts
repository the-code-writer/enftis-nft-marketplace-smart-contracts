...
export interface JWLRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MANAGER_ROLE"
...
export interface JWLRewards extends BaseContract {
  connect(runner?: ContractRunner | null): JWLRewards;
  waitForDeployment(): Promise<this>;

  interface: JWLRewardsInterface;
