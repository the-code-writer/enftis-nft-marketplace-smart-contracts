...
export interface N2DRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MANAGER_ROLE"
...
export interface N2DRewards extends BaseContract {
  connect(runner?: ContractRunner | null): N2DRewards;
  waitForDeployment(): Promise<this>;

  interface: N2DRewardsInterface;
