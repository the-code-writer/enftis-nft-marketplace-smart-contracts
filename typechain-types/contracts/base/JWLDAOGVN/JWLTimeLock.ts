...
export interface JWLTimeLockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "getTimeLockAdminRole",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface JWLTimeLock extends BaseContract {
  connect(runner?: ContractRunner | null): JWLTimeLock;
  waitForDeployment(): Promise<this>;

  interface: JWLTimeLockInterface;
  ...
  getTimeLockAdminRole: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getTimeLockAdminRole"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
