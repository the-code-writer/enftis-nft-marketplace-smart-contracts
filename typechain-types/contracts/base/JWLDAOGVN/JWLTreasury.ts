...
export declare namespace JWLTreasury {
...
export interface JWLTreasuryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "approve"
...
export interface JWLTreasury extends BaseContract {
  connect(runner?: ContractRunner | null): JWLTreasury;
  waitForDeployment(): Promise<this>;

  interface: JWLTreasuryInterface;
  ...
  createProposal: TypedContractMethod<
    ...
    [JWLTreasury.ExecutableProposalStructOutput],
    "payable"
  >;
