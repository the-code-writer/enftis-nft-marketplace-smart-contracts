...
export interface ERCTimeLockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERCTimeLock extends BaseContract {
  connect(runner?: ContractRunner | null): ERCTimeLock;
  waitForDeployment(): Promise<this>;

  interface: ERCTimeLockInterface;
