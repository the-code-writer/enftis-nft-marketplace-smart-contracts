...
export interface JWLDAOGVNBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface JWLDAOGVNBase extends BaseContract {
  connect(runner?: ContractRunner | null): JWLDAOGVNBase;
  waitForDeployment(): Promise<this>;

  interface: JWLDAOGVNBaseInterface;
