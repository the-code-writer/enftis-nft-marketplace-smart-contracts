...
export interface JWLXTKNFactoryBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface JWLXTKNFactoryBase extends BaseContract {
  connect(runner?: ContractRunner | null): JWLXTKNFactoryBase;
  waitForDeployment(): Promise<this>;

  interface: JWLXTKNFactoryBaseInterface;
  ...
  executeFunction: TypedContractMethod<
    [functionName: string, param1: string, param2: string],
    [void],
    "nonpayable"
  >;
  ...
  tokenTotalSupply: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "executeFunction"
  ): TypedContractMethod<
    [functionName: string, param1: string, param2: string],
    [void],
    "nonpayable"
