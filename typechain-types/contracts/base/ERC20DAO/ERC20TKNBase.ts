...
export interface ERC20TKNBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC20TKNBase extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20TKNBase;
  waitForDeployment(): Promise<this>;

  interface: ERC20TKNBaseInterface;
