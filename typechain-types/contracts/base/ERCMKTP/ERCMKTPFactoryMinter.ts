...
export interface ERCMKTPFactoryMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_tokenCurrentSupply"
...
export interface ERCMKTPFactoryMinter extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactoryMinter;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryMinterInterface;
