...
export interface ERCMKTPFactoryBurnerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_tokenCurrentSupply"
...
export interface ERCMKTPFactoryBurner extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactoryBurner;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryBurnerInterface;
