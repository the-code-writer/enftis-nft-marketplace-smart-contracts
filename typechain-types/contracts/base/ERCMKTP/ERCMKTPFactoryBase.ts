...
export interface ERCMKTPFactoryBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_listedItems"
...
export interface ERCMKTPFactoryBase extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactoryBase;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryBaseInterface;
