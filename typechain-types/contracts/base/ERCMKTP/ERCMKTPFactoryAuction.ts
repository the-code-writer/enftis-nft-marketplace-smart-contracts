...
export interface ERCMKTPFactoryAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_listedItems"
...
export interface ERCMKTPFactoryAuction extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactoryAuction;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryAuctionInterface;
