...
export interface ERCMKTPFactoryWorkerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_listedItems"
...
export interface ERCMKTPFactoryWorker extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTPFactoryWorker;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPFactoryWorkerInterface;
