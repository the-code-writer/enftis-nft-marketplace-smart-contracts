...
export interface ERC20TKNFactoryBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC20TKNFactoryBase extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20TKNFactoryBase;
  waitForDeployment(): Promise<this>;

  interface: ERC20TKNFactoryBaseInterface;
