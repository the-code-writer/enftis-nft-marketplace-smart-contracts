...
export interface JWLXTKNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface JWLXTKN extends BaseContract {
  connect(runner?: ContractRunner | null): JWLXTKN;
  waitForDeployment(): Promise<this>;

  interface: JWLXTKNInterface;
