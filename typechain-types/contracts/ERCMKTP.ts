...
export interface ERCMKTPInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "_tokenCurrentSupply"
...
export interface ERCMKTP extends BaseContract {
  connect(runner?: ContractRunner | null): ERCMKTP;
  waitForDeployment(): Promise<this>;

  interface: ERCMKTPInterface;
