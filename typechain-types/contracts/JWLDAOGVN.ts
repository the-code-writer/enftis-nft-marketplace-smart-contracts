...
export interface JWLDAOGVNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface JWLDAOGVN extends BaseContract {
  connect(runner?: ContractRunner | null): JWLDAOGVN;
  waitForDeployment(): Promise<this>;

  interface: JWLDAOGVNInterface;
