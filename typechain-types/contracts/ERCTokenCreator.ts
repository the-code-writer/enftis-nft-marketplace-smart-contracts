...
export interface ERCTokenCreatorInterface extends Interface {
  getFunction(
...
export interface ERCTokenCreator extends BaseContract {
  connect(runner?: ContractRunner | null): ERCTokenCreator;
  waitForDeployment(): Promise<this>;

  interface: ERCTokenCreatorInterface;
