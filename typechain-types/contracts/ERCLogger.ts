...
export interface ERCLoggerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ERCLogger extends BaseContract {
  connect(runner?: ContractRunner | null): ERCLogger;
  waitForDeployment(): Promise<this>;

  interface: ERCLoggerInterface;
