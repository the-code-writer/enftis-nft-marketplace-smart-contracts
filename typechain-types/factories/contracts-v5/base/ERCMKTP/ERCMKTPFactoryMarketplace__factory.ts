...
import type {
  ERCMKTPFactoryMarketplace,
  ERCMKTPFactoryMarketplaceInterface,
} from "../../../../contracts-v5/base/ERCMKTP/ERCMKTPFactoryMarketplace";
...
export class ERCMKTPFactoryMarketplace__factory {
  static readonly abi = _abi;
  static createInterface(): ERCMKTPFactoryMarketplaceInterface {
    return new Interface(_abi) as ERCMKTPFactoryMarketplaceInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERCMKTPFactoryMarketplace;
  }
}
