...
import type {
  ...
  ERCMKTPFactoryWorkerInterface,
} from "../../../../contracts-v5/base/ERCMKTP/ERCMKTPFactoryWorker";
...
export class ERCMKTPFactoryWorker__factory {
  static readonly abi = _abi;
  static createInterface(): ERCMKTPFactoryWorkerInterface {
    return new Interface(_abi) as ERCMKTPFactoryWorkerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERCMKTPFactoryWorker;
  }
}
