...
import type {
  ERCMKTPFactoryBurner,
  ERCMKTPFactoryBurnerInterface,
} from "../../../../contracts/base/ERCMKTP/ERCMKTPFactoryBurner";
...
export class ERCMKTPFactoryBurner__factory {
  static readonly abi = _abi;
  static createInterface(): ERCMKTPFactoryBurnerInterface {
    return new Interface(_abi) as ERCMKTPFactoryBurnerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERCMKTPFactoryBurner;
  }
}
