...
import type {
  ERCMKTPFactoryMinter,
  ERCMKTPFactoryMinterInterface,
} from "../../../../contracts/base/ERCMKTP/ERCMKTPFactoryMinter";
...
export class ERCMKTPFactoryMinter__factory {
  static readonly abi = _abi;
  static createInterface(): ERCMKTPFactoryMinterInterface {
    return new Interface(_abi) as ERCMKTPFactoryMinterInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERCMKTPFactoryMinter;
  }
}
